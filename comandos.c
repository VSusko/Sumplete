...
#include "auxiliares.h"
    ...
    void Resolver(InfoTabuleiro tabuleiro, Jogadores player, int ***BackEnding, int** gabarito, time_t begin)
    {
    ...
    void Dica(InfoTabuleiro tabuleiro,int ***BackEnding, int **gabarito, int *contadicas, int conta1)
    {
    ...
    void Salvar(char *comando, Jogadores player, InfoTabuleiro tabuleiro, int** gabarito, int** matriz, time_t begin)
    {
        if(comando[6] == '\n')
        {
            printf("\n\nFormato ");
    ...
    void Remover(InfoTabuleiro tabuleiro, char *comando, int ***BackEnding, int *contadicas, int **gabarito, int *acao)
    {
        int linha, coluna;
    ...
    void Manter(char *comando, InfoTabuleiro tabuleiro, int ***BackEnding)
    {
        int linha, coluna;
